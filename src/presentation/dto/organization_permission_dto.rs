...
pub struct CreateOrganizationPermissionDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "permission_name")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "role_id")]
...
pub struct PatchOrganizationPermissionDto {
    ...
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "permission_name")]
    pub permission_name: Option<String>,
