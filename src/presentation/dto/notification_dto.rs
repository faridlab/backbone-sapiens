...
pub struct CreateNotificationDto {
    ...
    #[serde(alias = "is_read")]
    pub is_read: bool,
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "read_at")]
    ...
    #[cfg_attr(feature = "validation", validate(url, length(max = 500)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "action_url")]
    pub action_url: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "action_text")]
...
pub struct PatchNotificationDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "read_at")]
    pub read_at: Option<DateTime<Utc>>,
    ...
    #[cfg_attr(feature = "validation", validate(url, length(max = 500)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "action_url")]
    pub action_url: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "action_text")]
    pub action_text: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 50)))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub category: Option<String>,
