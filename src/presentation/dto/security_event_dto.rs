...
pub struct CreateSecurityEventDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "resolved_by_user_id")]
...
pub struct PatchSecurityEventDto {
    ...
    pub resolved_at: Option<DateTime<Utc>>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "resolved_by_user_id")]
    pub resolved_by_user_id: Option<Uuid>,
    #[cfg_attr(feature = "validation", validate(length(max = 1000)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "resolution_notes")]
    pub resolution_notes: Option<String>,
}
