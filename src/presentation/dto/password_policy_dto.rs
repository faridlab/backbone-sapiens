...
pub struct CreatePasswordPolicyDto {
    ...
    #[serde(alias = "reset_settings")]
    pub reset_settings: serde_json::Value,
    #[serde(alias = "expiry_settings")]
...
pub struct PatchPasswordPolicyDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "reset_settings")]
    pub reset_settings: Option<serde_json::Value>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "expiry_settings")]
...
impl PatchPasswordPolicyDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.name.is_some() || self.org_unit_id.is_some() || self.status.is_some() || self.password_requirements.is_some() || self.password_history.is_some() || self.reset_settings.is_some() || self.expiry_settings.is_some()
    }
}
