...
pub struct CreatePasswordResetDto {
    ...
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(alias = "attempts_remaining")]
    pub attempts_remaining: i32,
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "last_attempt_at")]
    pub last_attempt_at: Option<DateTime<Utc>>,
    #[serde(alias = "request_metadata")]
    pub request_metadata: serde_json::Value,
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "verification_details_id")]
    pub verification_details_id: Option<Uuid>,
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "completion_details_id")]
    pub completion_details_id: Option<Uuid>,
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "security_id")]
...
pub struct PatchPasswordResetDto {
    ...
    #[cfg_attr(feature = "validation", validate(range(min = 1), range(max = 10)))]
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "max_attempts")]
    pub max_attempts: Option<i32>,
    #[cfg_attr(feature = "validation", validate(range(min = 0)))]
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "attempts_remaining")]
    pub attempts_remaining: Option<i32>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "last_attempt_at")]
    pub last_attempt_at: Option<DateTime<Utc>>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "request_metadata")]
    pub request_metadata: Option<serde_json::Value>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "verification_details_id")]
    pub verification_details_id: Option<Uuid>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "completion_details_id")]
    pub completion_details_id: Option<Uuid>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "security_id")]
    pub security_id: Option<Uuid>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
