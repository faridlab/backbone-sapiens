...
pub struct CreateMFADeviceDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "device_name")]
    pub device_name: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 20)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "phone_number")]
    pub phone_number: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "email_address")]
    pub email_address: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 64)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "totp_secret")]
    pub totp_secret: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secret: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "hardware_key_id")]
    pub hardware_key_id: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "push_token")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "operating_system")]
    pub operating_system: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 20)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "app_version")]
    ...
    pub usage_count: i32,
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(alias = "successful_verifications")]
...
pub struct PatchMFADeviceDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "device_type")]
    pub device_type: Option<MFADeviceType>,
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "device_name")]
    pub device_name: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 20)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "phone_number")]
    pub phone_number: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "email_address")]
    pub email_address: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 64)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "totp_secret")]
    pub totp_secret: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 100)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "hardware_key_id")]
    pub hardware_key_id: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "push_token")]
    pub push_token: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 255)))]
    ...
    pub model: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 50)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "operating_system")]
    pub operating_system: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 20)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "app_version")]
    pub app_version: Option<String>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "is_primary")]
    pub is_primary: Option<bool>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "is_backup")]
    pub is_backup: Option<bool>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "requires_verification")]
    pub requires_verification: Option<bool>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "auto_approval_enabled")]
    pub auto_approval_enabled: Option<bool>,
    #[cfg_attr(feature = "validation", validate(range(min = 1), range(max = 168)))]
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "trusted_duration_hours")]
    pub trusted_duration_hours: Option<i32>,
    #[cfg_attr(feature = "openapi", schema(example = "2024-01-01T00:00:00Z"))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "enrolled_at")]
    pub enrolled_at: Option<DateTime<Utc>>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "enrolled_by")]
    pub enrolled_by: Option<Uuid>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "enrollment_method")]
    pub enrollment_method: Option<EnrollmentMethod>,
    #[cfg_attr(feature = "validation", validate(length(max = 45)))]
    #[cfg_attr(feature = "openapi", schema(example = "example"))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "enrollment_ip")]
    pub enrollment_ip: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "enrollment_user_agent")]
    pub enrollment_user_agent: Option<String>,
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "verification_attempts")]
    pub verification_attempts: Option<i32>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "backup_codes_generated")]
    pub backup_codes_generated: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "verified_at")]
    pub verified_at: Option<DateTime<Utc>>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "last_used")]
    pub last_used: Option<DateTime<Utc>>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "last_used_at")]
    pub last_used_at: Option<DateTime<Utc>>,
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "usage_count")]
    pub usage_count: Option<i32>,
    #[cfg_attr(feature = "openapi", schema(example = 42))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "successful_verifications")]
