...
impl UserTransition {
    ...
    pub fn target_state(&self) -> UserState {
        match self {
...
impl UserStateMachine {
    ...
    pub fn from_state(state: UserState) -> Self {
    ...
    pub fn can_transition(&self, transition: UserTransition) -> bool {
    ...
    pub fn can_transition_with_role(&self, transition: UserTransition, role: &str) -> bool {
    ...
    pub fn transition(&mut self, transition: UserTransition) -> Result<UserState, StateMachineError> {
        if !self.can_transition(transition) {
    ...
    pub fn transition_with_role(&mut self, transition: UserTransition, role: &str) -> Result<UserState, StateMachineError> {
    ...
    pub fn available_transitions(&self) -> Vec<UserTransition> {
        UserTransition::all()
            .into_iter()
    ...
    pub fn available_transitions_for_role(&self, role: &str) -> Vec<UserTransition> {
        UserTransition::all()
            .into_iter()
    ...
    pub fn transition_to_state(&mut self, target: UserState) -> Result<UserState, StateMachineError> {
        let valid = UserTransition::all().into_iter()
            .filter(|t| self.can_transition(*t))
...
mod tests {
    ...
    fn test_valid_transition() {
        let mut sm = UserStateMachine::from_state(UserState::PendingVerification);
