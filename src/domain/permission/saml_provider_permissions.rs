//! Permission guard for SAMLProvider
//!
...
struct SAMLProviderRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for SAMLProvider resources
#[derive(Debug, Clone)]
pub struct SAMLProviderPermissions {
    rules: HashMap<String, SAMLProviderRoleRules>,
}

impl SAMLProviderPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = SAMLProviderRoleRules::default();
...
impl Default for SAMLProviderPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for SAMLProviderPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = SAMLProviderPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = SAMLProviderPermissions::new();
    }
