//! Permission guard for AnonymizationRecord
//!
...
struct AnonymizationRecordRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for AnonymizationRecord resources
#[derive(Debug, Clone)]
pub struct AnonymizationRecordPermissions {
    rules: HashMap<String, AnonymizationRecordRoleRules>,
}

impl AnonymizationRecordPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = AnonymizationRecordRoleRules::default();
...
impl Default for AnonymizationRecordPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for AnonymizationRecordPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = AnonymizationRecordPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = AnonymizationRecordPermissions::new();
    }
