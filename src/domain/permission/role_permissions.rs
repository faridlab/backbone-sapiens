...
impl RolePermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = RoleRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'assign_permission' - implement separately
            // TODO: Custom action 'revoke_permission' - implement separately
        ...
        // user role
        {
            let mut role_perms = RoleRoleRules::default();
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.field_restrictions.insert(Action::Read, FieldRestriction::Only(HashSet::from(["id".to_string(), "name".to_string(), "description".to_string(), "is_default".to_string()])));
            role_perms.allowed_actions.insert(Action::List);
...
impl PermissionChecker for RolePermissions {
...
mod tests {
    ...
    fn test_super_admin_role() {
        let _perms = RolePermissions::new();
    }
