//! Permission guard for PasswordResetToken
//!
...
struct PasswordResetTokenRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for PasswordResetToken resources
#[derive(Debug, Clone)]
pub struct PasswordResetTokenPermissions {
    rules: HashMap<String, PasswordResetTokenRoleRules>,
}

impl PasswordResetTokenPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = PasswordResetTokenRoleRules::default();
        ...
        // system role
        {
            ...
            role_perms.allowed_actions.insert(Action::Read);
            // TODO: Custom action 'use' - implement separately
            role_perms.denied_actions.insert(Action::Update);
            role_perms.denied_actions.insert(Action::Delete);
...
impl Default for PasswordResetTokenPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for PasswordResetTokenPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = PasswordResetTokenPermissions::new();
    ...
    fn test_super_admin_role() {
        let perms = PasswordResetTokenPermissions::new();
        assert!(perms.can("super_admin", Action::Read));
    ...
    #[test]
    fn test_user_role() {
        let _perms = PasswordResetTokenPermissions::new();
    }
