//! Permission guard for EmailVerificationToken
//!
...
struct EmailVerificationTokenRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for EmailVerificationToken resources
#[derive(Debug, Clone)]
pub struct EmailVerificationTokenPermissions {
    rules: HashMap<String, EmailVerificationTokenRoleRules>,
}

impl EmailVerificationTokenPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = EmailVerificationTokenRoleRules::default();
...
impl Default for EmailVerificationTokenPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for EmailVerificationTokenPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = EmailVerificationTokenPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = EmailVerificationTokenPermissions::new();
    }
    ...
    fn test_system_role() {
        ...
        assert!(!perms.can("system", Action::Delete));
    }
