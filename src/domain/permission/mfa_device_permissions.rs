//! Permission guard for MFADevice
//!
...
struct MFADeviceRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for MFADevice resources
#[derive(Debug, Clone)]
pub struct MFADevicePermissions {
    rules: HashMap<String, MFADeviceRoleRules>,
}

impl MFADevicePermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = MFADeviceRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'disable' - implement separately
        ...
        // user role
        {
            ...
            role_perms.field_restrictions.insert(Action::Update, FieldRestriction::Only(HashSet::from(["device_name".to_string()])));
            // TODO: Custom action 'disable' - implement separately
            role_perms.denied_actions.insert(Action::Delete);
...
impl Default for MFADevicePermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for MFADevicePermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = MFADevicePermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = MFADevicePermissions::new();
    }
