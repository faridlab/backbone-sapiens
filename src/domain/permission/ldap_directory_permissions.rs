//! Permission guard for LDAPDirectory
//!
...
struct LDAPDirectoryRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for LDAPDirectory resources
#[derive(Debug, Clone)]
pub struct LDAPDirectoryPermissions {
    rules: HashMap<String, LDAPDirectoryRoleRules>,
}

impl LDAPDirectoryPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = LDAPDirectoryRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'deactivate' - implement separately
            // TODO: Custom action 'test_connection' - implement separately
            // TODO: Custom action 'sync' - implement separately
...
impl Default for LDAPDirectoryPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for LDAPDirectoryPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = LDAPDirectoryPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = LDAPDirectoryPermissions::new();
    }
    ...
    fn test_system_role() {
        let perms = LDAPDirectoryPermissions::new();
        assert!(perms.can("system", Action::Read));
    }
