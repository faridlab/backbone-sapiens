...
struct AuditLogRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for AuditLog resources
#[derive(Debug, Clone)]
pub struct AuditLogPermissions {
    rules: HashMap<String, AuditLogRoleRules>,
}

impl AuditLogPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = AuditLogRoleRules::default();
        ...
        // compliance_officer role
        {
            ...
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.allowed_actions.insert(Action::List);
            // TODO: Custom action 'export' - implement separately
            role_perms.denied_actions.insert(Action::Create);
            role_perms.denied_actions.insert(Action::Update);
            role_perms.denied_actions.insert(Action::Delete);
            rules.insert("compliance_officer".to_string(), role_perms);
        }
        // user role
        {
            let mut role_perms = AuditLogRoleRules::default();
        ...
        // system role
        {
            ...
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.allowed_actions.insert(Action::List);
            // TODO: Custom action 'archive' - implement separately
            role_perms.denied_actions.insert(Action::Update);
            role_perms.denied_actions.insert(Action::Delete);
...
impl Default for AuditLogPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for AuditLogPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = AuditLogPermissions::new();
    ...
    fn test_super_admin_role() {
        let perms = AuditLogPermissions::new();
        assert!(perms.can("super_admin", Action::Create));
        assert!(!perms.can("super_admin", Action::Update));
    }
    ...
    #[test]
    fn test_compliance_officer_role() {
        let perms = AuditLogPermissions::new();
        assert!(perms.can("compliance_officer", Action::Read));
        assert!(!perms.can("compliance_officer", Action::Create));
    }
    ...
    #[test]
    fn test_guest_role() {
        let _perms = AuditLogPermissions::new();
    }
