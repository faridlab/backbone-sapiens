//! Permission guard for OAuthProvider
//!
...
struct OAuthProviderRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for OAuthProvider resources
#[derive(Debug, Clone)]
pub struct OAuthProviderPermissions {
    rules: HashMap<String, OAuthProviderRoleRules>,
}

impl OAuthProviderPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = OAuthProviderRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'change_configuration' - implement separately
...
impl Default for OAuthProviderPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for OAuthProviderPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = OAuthProviderPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = OAuthProviderPermissions::new();
    }
