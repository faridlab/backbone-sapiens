...
impl SessionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = SessionRoleRules::default();
...
impl PermissionChecker for SessionPermissions {
...
mod tests {
    ...
    fn test_super_admin_role() {
        let _perms = SessionPermissions::new();
    }
