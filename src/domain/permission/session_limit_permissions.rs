//! Permission guard for SessionLimit
//!
...
struct SessionLimitRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for SessionLimit resources
#[derive(Debug, Clone)]
pub struct SessionLimitPermissions {
    rules: HashMap<String, SessionLimitRoleRules>,
}

impl SessionLimitPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = SessionLimitRoleRules::default();
        ...
        // user role
        {
            let mut role_perms = SessionLimitRoleRules::default();
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.field_restrictions.insert(Action::Read, FieldRestriction::Only(HashSet::from(["max_sessions".to_string(), "enforce_limit".to_string()])));
...
impl Default for SessionLimitPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for SessionLimitPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = SessionLimitPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = SessionLimitPermissions::new();
    }
