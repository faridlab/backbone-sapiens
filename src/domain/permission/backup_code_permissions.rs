//! Permission guard for BackupCode
//!
...
struct BackupCodeRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for BackupCode resources
#[derive(Debug, Clone)]
pub struct BackupCodePermissions {
    rules: HashMap<String, BackupCodeRoleRules>,
}

impl BackupCodePermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = BackupCodeRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'regenerate' - implement separately
        ...
        // system role
        {
            let role_perms = BackupCodeRoleRules::default();
            // TODO: Custom action 'verify' - implement separately
            // TODO: Custom action 'regenerate' - implement separately
...
impl Default for BackupCodePermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for BackupCodePermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = BackupCodePermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = BackupCodePermissions::new();
    }
