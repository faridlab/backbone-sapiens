//! Permission guard for ImpersonationSession
//!
...
struct ImpersonationSessionRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for ImpersonationSession resources
#[derive(Debug, Clone)]
pub struct ImpersonationSessionPermissions {
    rules: HashMap<String, ImpersonationSessionRoleRules>,
}

impl ImpersonationSessionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = ImpersonationSessionRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'end' - implement separately
            // TODO: Custom action 'terminate' - implement separately
        ...
        // audit role
        {
            ...
            // TODO: Custom action 'end' - implement separately
            // TODO: Custom action 'terminate' - implement separately
            rules.insert("audit".to_string(), role_perms);
        }
        // guest role
        {
            let mut role_perms = ImpersonationSessionRoleRules::default();
...
impl Default for ImpersonationSessionPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for ImpersonationSessionPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = ImpersonationSessionPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = ImpersonationSessionPermissions::new();
    }
    ...
    fn test_audit_role() {
        let perms = ImpersonationSessionPermissions::new();
        assert!(perms.can("audit", Action::Read));
        assert!(!perms.can("audit", Action::Create));
    }
