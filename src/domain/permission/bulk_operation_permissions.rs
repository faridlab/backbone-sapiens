//! Permission guard for BulkOperation
//!
...
struct BulkOperationRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for BulkOperation resources
#[derive(Debug, Clone)]
pub struct BulkOperationPermissions {
    rules: HashMap<String, BulkOperationRoleRules>,
}

impl BulkOperationPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = BulkOperationRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'pause' - implement separately
            // TODO: Custom action 'resume' - implement separately
        ...
        {
            let mut role_perms = BulkOperationRoleRules::default();
            // TODO: Custom action 'process' - implement separately
            role_perms.allowed_actions.insert(Action::Update);
            // TODO: Custom action 'retry' - implement separately
            // TODO: Custom action 'cleanup' - implement separately
            // TODO: Custom action 'monitor' - implement separately
...
impl Default for BulkOperationPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for BulkOperationPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = BulkOperationPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = BulkOperationPermissions::new();
    }
    ...
    fn test_system_role() {
        let perms = BulkOperationPermissions::new();
        assert!(perms.can("system", Action::Update));
    }
