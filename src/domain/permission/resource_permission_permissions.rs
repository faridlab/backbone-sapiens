//! Permission guard for ResourcePermission
//!
...
struct ResourcePermissionRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for ResourcePermission resources
#[derive(Debug, Clone)]
pub struct ResourcePermissionPermissions {
    rules: HashMap<String, ResourcePermissionRoleRules>,
}

impl ResourcePermissionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = ResourcePermissionRoleRules::default();
        ...
        // resource_owner role
        {
            ...
            role_perms.allowed_actions.insert(Action::List);
            // TODO: Custom action 'revoke' - implement separately
            rules.insert("resource_owner".to_string(), role_perms);
        }
        // user role
        {
            let mut role_perms = ResourcePermissionRoleRules::default();
...
impl Default for ResourcePermissionPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for ResourcePermissionPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = ResourcePermissionPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = ResourcePermissionPermissions::new();
    }
    ...
    #[test]
    fn test_resource_owner_role() {
        let perms = ResourcePermissionPermissions::new();
        assert!(perms.can("resource_owner", Action::Create));
    }
