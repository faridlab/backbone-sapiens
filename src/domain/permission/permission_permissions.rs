//! Permission guard for Permission
//!
...
impl PermissionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = PermissionRoleRules::default();
        ...
        // user role
        {
            let mut role_perms = PermissionRoleRules::default();
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.field_restrictions.insert(Action::Read, FieldRestriction::Only(HashSet::from(["id".to_string(), "name".to_string(), "description".to_string(), "resource".to_string(), "action".to_string()])));
            role_perms.allowed_actions.insert(Action::List);
            role_perms.denied_actions.insert(Action::Create);
            role_perms.denied_actions.insert(Action::Update);
            role_perms.denied_actions.insert(Action::Delete);
...
impl Default for PermissionPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for PermissionPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = PermissionPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = PermissionPermissions::new();
    }
