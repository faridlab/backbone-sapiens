...
impl ProfilePermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = ProfileRoleRules::default();
        ...
        // user role
        {
            ...
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.allowed_actions.insert(Action::Update);
            role_perms.field_restrictions.insert(Action::Update, FieldRestriction::Only(HashSet::from(["first_name".to_string(), "middle_name".to_string(), "last_name".to_string(), "phone_number".to_string(), "profile_picture_url".to_string(), "dob".to_string(), "pob".to_string(), "gender".to_string()])));
        ...
        // guest role
        {
            let mut role_perms = ProfileRoleRules::default();
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.field_restrictions.insert(Action::Read, FieldRestriction::Only(HashSet::from(["first_name".to_string(), "profile_picture_url".to_string()])));
            role_perms.denied_actions.insert(Action::Create);
...
impl PermissionChecker for ProfilePermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = ProfilePermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = ProfilePermissions::new();
    }
    ...
    fn test_guest_role() {
        let perms = ProfilePermissions::new();
        assert!(perms.can("guest", Action::Read));
