//! Permission guard for UserSAMLLink
//!
...
struct UserSAMLLinkRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for UserSAMLLink resources
#[derive(Debug, Clone)]
pub struct UserSAMLLinkPermissions {
    rules: HashMap<String, UserSAMLLinkRoleRules>,
}

impl UserSAMLLinkPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = UserSAMLLinkRoleRules::default();
...
impl Default for UserSAMLLinkPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for UserSAMLLinkPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = UserSAMLLinkPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = UserSAMLLinkPermissions::new();
    }
