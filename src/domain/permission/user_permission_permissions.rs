//! Permission guard for UserPermission
//!
...
struct UserPermissionRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for UserPermission resources
#[derive(Debug, Clone)]
pub struct UserPermissionPermissions {
    rules: HashMap<String, UserPermissionRoleRules>,
}

impl UserPermissionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = UserPermissionRoleRules::default();
...
impl Default for UserPermissionPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for UserPermissionPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = UserPermissionPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = UserPermissionPermissions::new();
    }
    ...
    fn test_admin_role() {
        ...
        assert!(!perms.can("admin", Action::Update));
    }
