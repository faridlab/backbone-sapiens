//! Permission guard for TemporaryPermission
//!
...
struct TemporaryPermissionRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for TemporaryPermission resources
#[derive(Debug, Clone)]
pub struct TemporaryPermissionPermissions {
    rules: HashMap<String, TemporaryPermissionRoleRules>,
}

impl TemporaryPermissionPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = TemporaryPermissionRoleRules::default();
...
impl Default for TemporaryPermissionPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for TemporaryPermissionPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = TemporaryPermissionPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = TemporaryPermissionPermissions::new();
    }
