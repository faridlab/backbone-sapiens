//! Permission guard for DataExport
//!
...
struct DataExportRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for DataExport resources
#[derive(Debug, Clone)]
pub struct DataExportPermissions {
    rules: HashMap<String, DataExportRoleRules>,
}

impl DataExportPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = DataExportRoleRules::default();
        ...
        // user role
        {
            ...
            role_perms.allowed_actions.insert(Action::Read);
            role_perms.allowed_actions.insert(Action::List);
            // TODO: Custom action 'download' - implement separately
...
impl Default for DataExportPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for DataExportPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = DataExportPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = DataExportPermissions::new();
    }
