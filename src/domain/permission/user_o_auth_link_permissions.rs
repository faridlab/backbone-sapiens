//! Permission guard for UserOAuthLink
//!
...
struct UserOAuthLinkRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for UserOAuthLink resources
#[derive(Debug, Clone)]
pub struct UserOAuthLinkPermissions {
    rules: HashMap<String, UserOAuthLinkRoleRules>,
}

impl UserOAuthLinkPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = UserOAuthLinkRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'unlink' - implement separately
...
impl Default for UserOAuthLinkPermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for UserOAuthLinkPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = UserOAuthLinkPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = UserOAuthLinkPermissions::new();
    }
