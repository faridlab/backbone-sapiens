//! Domain policy for AnalyticsMetric aggregate
//!
...
/// Domain policy for AnalyticsMetric — permits all operations (no business invariants).
///
/// To add domain rules, replace this alias with a struct implementing
/// `backbone_core::DomainPolicy<AnalyticsMetric>` in the `// <<< CUSTOM` zone.
pub type AnalyticsMetricDomainPolicy = PermitAllPolicy<AnalyticsMetric>;
