//! Specifications for Permission aggregate
//!
...
// Each predicate implements `Specification<Permission>` and can be combined
...
//
// pub struct ActivePermissionSpec;
// impl Specification<Permission> for ActivePermissionSpec {
//     fn is_satisfied_by(&self, e: &Permission) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct PermissionHasValidEmailSpec;
// impl PermissionSpecification for PermissionHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &Permission) -> bool {
