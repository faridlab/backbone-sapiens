//! Specifications for SecurityEvent aggregate
//!
...
// Each predicate implements `Specification<SecurityEvent>` and can be combined
...
//
// pub struct ActiveSecurityEventSpec;
// impl Specification<SecurityEvent> for ActiveSecurityEventSpec {
//     fn is_satisfied_by(&self, e: &SecurityEvent) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct SecurityEventHasValidEmailSpec;
// impl SecurityEventSpecification for SecurityEventHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &SecurityEvent) -> bool {
