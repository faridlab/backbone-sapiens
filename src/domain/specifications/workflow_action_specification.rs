//! Specifications for WorkflowAction aggregate
//!
...
// Each predicate implements `Specification<WorkflowAction>` and can be combined
...
//
// pub struct ActiveWorkflowActionSpec;
// impl Specification<WorkflowAction> for ActiveWorkflowActionSpec {
//     fn is_satisfied_by(&self, e: &WorkflowAction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct WorkflowActionHasValidEmailSpec;
// impl WorkflowActionSpecification for WorkflowActionHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &WorkflowAction) -> bool {
