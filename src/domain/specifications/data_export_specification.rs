//! Specifications for DataExport aggregate
//!
...
// Each predicate implements `Specification<DataExport>` and can be combined
...
//
// pub struct ActiveDataExportSpec;
// impl Specification<DataExport> for ActiveDataExportSpec {
//     fn is_satisfied_by(&self, e: &DataExport) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct DataExportHasValidEmailSpec;
// impl DataExportSpecification for DataExportHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &DataExport) -> bool {
