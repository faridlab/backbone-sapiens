//! Specifications for BulkOperation aggregate
//!
...
// Each predicate implements `Specification<BulkOperation>` and can be combined
...
//
// pub struct ActiveBulkOperationSpec;
// impl Specification<BulkOperation> for ActiveBulkOperationSpec {
//     fn is_satisfied_by(&self, e: &BulkOperation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct BulkOperationHasValidEmailSpec;
// impl BulkOperationSpecification for BulkOperationHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &BulkOperation) -> bool {
