//! Specifications for Workflow aggregate
//!
...
// Each predicate implements `Specification<Workflow>` and can be combined
...
//
// pub struct ActiveWorkflowSpec;
// impl Specification<Workflow> for ActiveWorkflowSpec {
//     fn is_satisfied_by(&self, e: &Workflow) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct WorkflowHasValidEmailSpec;
// impl WorkflowSpecification for WorkflowHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &Workflow) -> bool {
