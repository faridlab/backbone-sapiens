...
pub type TemporaryPermissionTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<TemporaryPermission>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for TemporaryPermission.
