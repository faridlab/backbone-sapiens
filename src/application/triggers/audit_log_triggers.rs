...
pub type AuditLogTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<AuditLog>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for AuditLog.
