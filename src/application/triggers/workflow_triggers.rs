...
pub type WorkflowTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Workflow>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for Workflow.
