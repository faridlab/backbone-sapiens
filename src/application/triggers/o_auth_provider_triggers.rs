...
pub type OAuthProviderTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<OAuthProvider>, TriggerEvent>;
...
impl TriggerHandler<OAuthProviderTriggerContext, OAuthProviderTriggerEvent> for OAuthProviderOnEnterMaintenanceHandler {
    fn events(&self) -> Vec<OAuthProviderTriggerEvent> {
        vec![TriggerEvent::OnEnterState("maintenance".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for OAuthProvider.
