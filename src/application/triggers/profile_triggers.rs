...
pub type ProfileTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Profile>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for Profile.
