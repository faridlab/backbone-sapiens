...
pub type SessionLimitTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<SessionLimit>, TriggerEvent>;
...
impl TriggerHandler<SessionLimitTriggerContext, SessionLimitTriggerEvent> for SessionLimitOnEnterEnforcedHandler {
    fn events(&self) -> Vec<SessionLimitTriggerEvent> {
        vec![TriggerEvent::OnEnterState("enforced".to_string())]
    }
...
impl TriggerHandler<SessionLimitTriggerContext, SessionLimitTriggerEvent> for SessionLimitOnEnterUnenforcedHandler {
    fn events(&self) -> Vec<SessionLimitTriggerEvent> {
        vec![TriggerEvent::OnEnterState("unenforced".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for SessionLimit.
