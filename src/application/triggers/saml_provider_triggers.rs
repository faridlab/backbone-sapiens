...
pub type SAMLProviderTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<SAMLProvider>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for SAMLProvider.
pub fn saml_provider_trigger_registry() -> SAMLProviderTriggerRegistry {
