...
pub type SessionTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Session>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for Session.
