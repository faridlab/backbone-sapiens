...
pub type MFADeviceTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<MFADevice>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for MFADevice.
pub fn mfa_device_trigger_registry() -> MFADeviceTriggerRegistry {
