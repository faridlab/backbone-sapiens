...
pub type PermissionTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Permission>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for Permission.
