...
pub type BackupCodeTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<BackupCode>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for BackupCode.
