...
pub type UserPermissionTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<UserPermission>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for UserPermission.
