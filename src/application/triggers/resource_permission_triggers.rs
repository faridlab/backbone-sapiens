...
pub type ResourcePermissionTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<ResourcePermission>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for ResourcePermission.
