...
pub type DeviceTrustTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<DeviceTrust>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for DeviceTrust.
