...
pub type UserSAMLLinkTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<UserSAMLLink>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for UserSAMLLink.
pub fn user_saml_link_trigger_registry() -> UserSAMLLinkTriggerRegistry {
