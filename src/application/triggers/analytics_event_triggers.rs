...
pub type AnalyticsEventTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<AnalyticsEvent>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for AnalyticsEvent.
