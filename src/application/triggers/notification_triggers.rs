...
pub type NotificationTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Notification>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for Notification.
