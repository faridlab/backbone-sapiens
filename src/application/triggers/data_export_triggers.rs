...
pub type DataExportTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<DataExport>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for DataExport.
