...
pub type UserTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<User>, TriggerEvent>;
...
impl TriggerHandler<UserTriggerContext, UserTriggerEvent> for UserOnEnterPendingVerificationHandler {
    fn events(&self) -> Vec<UserTriggerEvent> {
        vec![TriggerEvent::OnEnterState("pending_verification".to_string())]
    }
...
impl TriggerHandler<UserTriggerContext, UserTriggerEvent> for UserOnEnterSuspendedHandler {
    fn events(&self) -> Vec<UserTriggerEvent> {
        vec![TriggerEvent::OnEnterState("suspended".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for User.
