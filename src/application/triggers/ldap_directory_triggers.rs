...
pub type LDAPDirectoryTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<LDAPDirectory>, TriggerEvent>;
...
impl TriggerHandler<LDAPDirectoryTriggerContext, LDAPDirectoryTriggerEvent> for LDAPDirectoryOnEnterDraftHandler {
    fn events(&self) -> Vec<LDAPDirectoryTriggerEvent> {
        vec![TriggerEvent::OnEnterState("draft".to_string())]
    }
...
impl TriggerHandler<LDAPDirectoryTriggerContext, LDAPDirectoryTriggerEvent> for LDAPDirectoryOnEnterErrorHandler {
    fn events(&self) -> Vec<LDAPDirectoryTriggerEvent> {
        vec![TriggerEvent::OnEnterState("error".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for LDAPDirectory.
pub fn ldap_directory_trigger_registry() -> LDAPDirectoryTriggerRegistry {
