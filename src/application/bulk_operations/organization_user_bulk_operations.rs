//! Bulk Operations for OrganizationUser aggregate
//!
...
use crate::domain::repositories::OrganizationUserRepository;
use super::{BulkOperationConfig, BulkOperationProgress, BulkOperationResult, BulkOperationError};

/// Bulk operations handler for OrganizationUser
pub struct OrganizationUserBulkOperations<R: OrganizationUserRepository> {
    repository: Arc<R>,
    config: BulkOperationConfig,
}

impl<R: OrganizationUserRepository> OrganizationUserBulkOperations<R> {
    ...
    /// Bulk create organization_user entities with batching and error recovery
    pub async fn bulk_create(&self, entities: Vec<OrganizationUser>) -> Result<BulkOperationResult<OrganizationUser>> {
    ...
    /// Bulk update organization_user entities with batching and error recovery
    pub async fn bulk_update(&self, entities: Vec<OrganizationUser>) -> Result<BulkOperationResult<OrganizationUser>> {
        let total = entities.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
    ...
    /// Bulk delete organization_user entities by IDs with batching and error recovery
    ...
    /// Bulk soft delete organization_user entities by IDs
    ...
    /// Bulk restore soft-deleted organization_user entities by IDs
    pub async fn bulk_restore(&self, ids: Vec<String>) -> Result<BulkOperationResult<OrganizationUser>> {
        let total = ids.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
