//! Bulk Operations for BulkOperationResult aggregate
//!
...
use crate::domain::repositories::BulkOperationResultRepository;
use super::{BulkOperationConfig, BulkOperationProgress, BulkOperationResult, BulkOperationError};

/// Bulk operations handler for BulkOperationResult
pub struct BulkOperationResultBulkOperations<R: BulkOperationResultRepository> {
    repository: Arc<R>,
    config: BulkOperationConfig,
}

impl<R: BulkOperationResultRepository> BulkOperationResultBulkOperations<R> {
    ...
    /// Bulk create bulk_operation_result entities with batching and error recovery
    pub async fn bulk_create(&self, entities: Vec<BulkOperationResult>) -> Result<BulkOperationResult<BulkOperationResult>> {
    ...
    /// Bulk update bulk_operation_result entities with batching and error recovery
    pub async fn bulk_update(&self, entities: Vec<BulkOperationResult>) -> Result<BulkOperationResult<BulkOperationResult>> {
        let total = entities.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
    ...
    /// Bulk delete bulk_operation_result entities by IDs with batching and error recovery
    ...
    /// Bulk soft delete bulk_operation_result entities by IDs
    ...
    /// Bulk restore soft-deleted bulk_operation_result entities by IDs
    pub async fn bulk_restore(&self, ids: Vec<String>) -> Result<BulkOperationResult<BulkOperationResult>> {
        let total = ids.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
