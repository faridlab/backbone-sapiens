//! Bulk Operations for WorkflowActionExecution aggregate
//!
...
use crate::domain::repositories::WorkflowActionExecutionRepository;
use super::{BulkOperationConfig, BulkOperationProgress, BulkOperationResult, BulkOperationError};

/// Bulk operations handler for WorkflowActionExecution
pub struct WorkflowActionExecutionBulkOperations<R: WorkflowActionExecutionRepository> {
    repository: Arc<R>,
    config: BulkOperationConfig,
}

impl<R: WorkflowActionExecutionRepository> WorkflowActionExecutionBulkOperations<R> {
    ...
    /// Bulk create workflow_action_execution entities with batching and error recovery
    pub async fn bulk_create(&self, entities: Vec<WorkflowActionExecution>) -> Result<BulkOperationResult<WorkflowActionExecution>> {
    ...
    /// Bulk update workflow_action_execution entities with batching and error recovery
    pub async fn bulk_update(&self, entities: Vec<WorkflowActionExecution>) -> Result<BulkOperationResult<WorkflowActionExecution>> {
        let total = entities.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
    ...
    /// Bulk delete workflow_action_execution entities by IDs with batching and error recovery
    ...
    /// Bulk soft delete workflow_action_execution entities by IDs
    ...
    /// Bulk restore soft-deleted workflow_action_execution entities by IDs
    pub async fn bulk_restore(&self, ids: Vec<String>) -> Result<BulkOperationResult<WorkflowActionExecution>> {
        let total = ids.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
