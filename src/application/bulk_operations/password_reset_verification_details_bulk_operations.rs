//! Bulk Operations for PasswordResetVerificationDetails aggregate
//!
...
use crate::domain::repositories::PasswordResetVerificationDetailsRepository;
use super::{BulkOperationConfig, BulkOperationProgress, BulkOperationResult, BulkOperationError};

/// Bulk operations handler for PasswordResetVerificationDetails
pub struct PasswordResetVerificationDetailsBulkOperations<R: PasswordResetVerificationDetailsRepository> {
    repository: Arc<R>,
    config: BulkOperationConfig,
}

impl<R: PasswordResetVerificationDetailsRepository> PasswordResetVerificationDetailsBulkOperations<R> {
    ...
    /// Bulk create password_reset_verification_details entities with batching and error recovery
    pub async fn bulk_create(&self, entities: Vec<PasswordResetVerificationDetails>) -> Result<BulkOperationResult<PasswordResetVerificationDetails>> {
    ...
    /// Bulk update password_reset_verification_details entities with batching and error recovery
    pub async fn bulk_update(&self, entities: Vec<PasswordResetVerificationDetails>) -> Result<BulkOperationResult<PasswordResetVerificationDetails>> {
        let total = entities.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
    ...
    /// Bulk delete password_reset_verification_details entities by IDs with batching and error recovery
    ...
    /// Bulk soft delete password_reset_verification_details entities by IDs
    ...
    /// Bulk restore soft-deleted password_reset_verification_details entities by IDs
    pub async fn bulk_restore(&self, ids: Vec<String>) -> Result<BulkOperationResult<PasswordResetVerificationDetails>> {
        let total = ids.len();
        let mut progress = BulkOperationProgress::new(total, self.config.batch_size);
        let mut result = BulkOperationResult::new(progress.clone());
