// CreateRolePermission Command
// Command for creating new RolePermission entities
...
impl CreateRolePermissionCommand {
    pub fn new(
...
pub struct CreateRolePermissionResponse {
    pub success: bool,
    pub message: String,
    pub role_permission: Option<RolePermissionDto>,
}

impl CreateRolePermissionResponse {
    pub fn success(role_permission: RolePermissionDto) -> Self {
        Self {
            success: true,
