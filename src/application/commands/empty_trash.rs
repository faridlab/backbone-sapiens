// EmptyTrash Command
// Command for permanently deleting all soft-deleted SystemSettings entities
...
impl EmptyTrashResponse {
    pub fn success(deleted_count: usize) -> Self {
        Self {
            success: true,
            message: format!("Permanently deleted {} system_settingses from trash", deleted_count),
            deleted_count,
        }
    }
