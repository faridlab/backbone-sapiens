...
CREATE INDEX IF NOT EXISTS idx_password_requirements_metadata_created_at ON password_requirements ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_password_requirements_metadata_updated_at ON password_requirements ((metadata->>'updated_at'));
