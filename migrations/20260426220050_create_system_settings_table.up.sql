...
CREATE INDEX IF NOT EXISTS idx_system_settings_metadata_created_at ON system_settings ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_system_settings_metadata_updated_at ON system_settings ((metadata->>'updated_at'));
