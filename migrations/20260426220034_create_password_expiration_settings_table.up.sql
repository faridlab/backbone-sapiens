...
CREATE TABLE IF NOT EXISTS sapiens.password_expiration_settings (
...
CREATE INDEX IF NOT EXISTS idx_password_expiration_settings_metadata_gin ON sapiens.password_expiration_settings USING GIN (metadata);
CREATE INDEX IF NOT EXISTS idx_password_expiration_settings_metadata_deleted_at ON sapiens.password_expiration_settings ((metadata->>'deleted_at'));
CREATE INDEX IF NOT EXISTS idx_password_expiration_settings_metadata_created_at ON sapiens.password_expiration_settings ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_password_expiration_settings_metadata_updated_at ON sapiens.password_expiration_settings ((metadata->>'updated_at'));
