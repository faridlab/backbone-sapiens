...
--
-- This file contains initial seed data for the sapiens.mfa_devices table.
-- Customize this file to add your initial data.

-- INSERT INTO sapiens.mfa_devices (
--     id,
--     user_id,
--     device_type,
--     device_name,
...
-- INSERT INTO sapiens.mfa_devices (id, code, name, is_active, created_at, updated_at) VALUES
