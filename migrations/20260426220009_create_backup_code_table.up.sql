...
CREATE TABLE IF NOT EXISTS sapiens.backup_codes (
...
CREATE INDEX IF NOT EXISTS idx_backup_codes_user_id_batch_id ON sapiens.backup_codes (user_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_backup_codes_user_id_is_used ON sapiens.backup_codes (user_id, is_used);

CREATE INDEX IF NOT EXISTS idx_backup_codes_expires_at ON sapiens.backup_codes (expires_at);

CREATE INDEX IF NOT EXISTS idx_backup_codes_used_at ON sapiens.backup_codes (used_at);
...
CREATE INDEX IF NOT EXISTS idx_backup_codes_metadata_deleted_at ON sapiens.backup_codes ((metadata->>'deleted_at'));
CREATE INDEX IF NOT EXISTS idx_backup_codes_metadata_created_at ON sapiens.backup_codes ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_backup_codes_metadata_updated_at ON sapiens.backup_codes ((metadata->>'updated_at'));
...
ALTER TABLE sapiens.backup_codes ADD CONSTRAINT fk_backup_codes_user_id FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE;
