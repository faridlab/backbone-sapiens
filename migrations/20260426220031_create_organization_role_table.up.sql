...
CREATE INDEX IF NOT EXISTS idx_organization_roles_metadata_created_at ON organization_roles ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_organization_roles_metadata_updated_at ON organization_roles ((metadata->>'updated_at'));
