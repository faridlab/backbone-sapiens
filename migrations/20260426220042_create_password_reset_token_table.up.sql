...
CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_metadata_created_at ON password_reset_tokens ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_metadata_updated_at ON password_reset_tokens ((metadata->>'updated_at'));
