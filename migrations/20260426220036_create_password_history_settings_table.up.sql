...
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_created_at ON password_history_settings ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_updated_at ON password_history_settings ((metadata->>'updated_at'));
