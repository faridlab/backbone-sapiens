...
CREATE TABLE IF NOT EXISTS sapiens.password_history_settings (
...
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_gin ON sapiens.password_history_settings USING GIN (metadata);
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_deleted_at ON sapiens.password_history_settings ((metadata->>'deleted_at'));
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_created_at ON sapiens.password_history_settings ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_password_history_settings_metadata_updated_at ON sapiens.password_history_settings ((metadata->>'updated_at'));
